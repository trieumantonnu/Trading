...
class LSTMTrainer:
    ...
    def fit(self, X_train, y_train):
        ...
        for epoch in range(self.epochs):
            ...
            print(
                f"[Epoch Summary] {epoch+1}/{self.epochs} | "
                f"loss={avg_loss:.6f} | "
                f"acc={acc:.4f} | "
...
class generateSignal(Methods):
    ...
    def generate_signals(
        ...
        cond_long = (future_ret > return_threshold)
        cond_short = (future_ret < -return_threshold) 
        ...
        # Scale features
        # -------------------------------------------------
        split_idx = self.df.index.get_loc('2026-02-01 00:00:00')
        ...
        # print(split_idx)
        # print(self.df.index[split_idx]) 2026-02-01 00:00:00
        split_idx = self.df.index.get_loc('2026-02-01 00:00:00') - (seq_len - 1)
        ...
        save_model=True
        model_path="./log/lstm_model5.pth"
        ...
        # spread_filter = (self.df["spread"] <= 50).reindex(pred_signal.index).fillna(False)
